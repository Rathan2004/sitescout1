...
export const mockListings: Listing[] = [
  ...
  },
  {
    ...
    description: 'Beautiful portfolio website template, perfect for creatives. Fully customizable with modern design.',
    domain: 'creativespace.design',
    price: 150,
    currency: 'USD',
    listingType: 'rent',
    category: 'Portfolio',
  ...
  },
  {
    ...
    description: 'Automated news aggregation site with RSS feeds and content curation. Monthly rental includes hosting.',
    domain: 'dailynewshub.com',
    price: 500,
    currency: 'USD',
    listingType: 'rent',
    category: 'News',
